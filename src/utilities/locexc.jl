...
dirPathUp = "data/pbc/nosector/dsh$(dsh)dsv$(dsv)/L$L"
...
dirPath = "data/pbc/nosector/dsh$(dsh)dsv$(dsv)/L$L/g4=$g4"
...
extArray = 0:(Int((L-1)/2))
for exti in eachindex(0:(Int((L-1)/2)))
ext = extArray[exti]
w = 2 * ext + 1 # An odd number
println("w = $w")
